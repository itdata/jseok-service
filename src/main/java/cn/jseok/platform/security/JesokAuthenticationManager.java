...
public class JesokAuthenticationManager implements  AuthenticationManager, MessageSourceAware, InitializingBean {
    private static final Log logger = LogFactory.getLog(ProviderManager.class);

    private AuthenticationEventPublisher eventPublisher = new JesokAuthenticationManager.NullEventPublisher();
     ...
     */
    public JesokAuthenticationManager(AuthenticationProvider... providers) {
     ...
     * @param providers the {@link AuthenticationProvider}s to use
     */
    public JesokAuthenticationManager(List<AuthenticationProvider> providers) {
        this(providers, null);
    }
     ...
     */
    public JesokAuthenticationManager(List<AuthenticationProvider> providers, AuthenticationManager parent) {
